...
export default function HeroHeader() {
  return (
    <header className="flex flex-col items-center gap-6 text-center">
      <div className="inline-flex items-center gap-2.5 rounded-full border border-turq-200 bg-turq-50/80 px-4 py-2 text-sm font-medium text-turq-700 shadow-sm backdrop-blur-none dark:border-turq-800 dark:bg-turq-900/50 dark:text-turq-300">
      ...
      <div className="relative">
        <Sparkles className="absolute -top-3 -right-6 hidden h-6 w-6 text-gold-400 opacity-80 sm:-right-10 sm:block sm:h-8 sm:w-8" />

        <h1 className="relative text-4xl font-black tracking-tight text-ink-900 sm:text-6xl md:text-7xl dark:text-stone-50">
      ...
      <p className="max-w-2xl text-base leading-relaxed text-stone-600 sm:text-xl dark:text-stone-400">
